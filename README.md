...
| `templates/sitemapConfig.ts` | Shared `@astrojs/sitemap` filter/serialize config | `seo-geo-trinity/apps/*/astro.config.mjs` (2026-07-23, was duplicated identically 4x) |
| `templates/robots.txt.template` + `generateRobotsTxt.ts` | Parameterized robots.txt template + generator | `seo-geo-trinity/apps/*/public/robots.txt` (2026-07-23, sites previously shipped 4 near-identical static files) |
